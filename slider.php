<div class="cycloneslider cycloneslider-template-thumbnails cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?> rodman-slider"
...
<div id="<?php echo $slider_html_id; ?>-pager" class="cycloneslider-template-thumbnails cycloneslider-thumbnails"
  ...
  <ul class="clearfix">
    <?php foreach($slides as $i=>$slide): ?>
      <?php if ( 'image' == $slide['type'] ) : ?>
        <li>
          <img src="<?php echo $slide['image_thumbnails']['80_80_exact']; ?>" width="80" height="80" alt="<?php echo $slide['img_alt'];?>" title="<?php echo $slide['img_title'];?>" />
        </li>
            <?php elseif ( 'youtube' == $slide['type'] ) : ?>
                <li>
